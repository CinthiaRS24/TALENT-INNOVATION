<template>
    ...
    >
        ...
        <v-card color="#23436b" class="text-center mr-2 ml-2 rounded-lg"  v-if="mentorSelected">
            ...
            <p class="title white--text font-weight-light mb-0">
                {{mentorSelected.name}}
            </p>

            <p class="subtitle-2 white--text font-weight-light mb-3">
                {{mentorSelected.role}}
            </p>

            <p class="subtitle-2 text-start ml-4 white--text font-weight-light mb-0">
                Habilidades
            </p>

            <v-container class="d-flex justify-space-around pb-4 pt-2">
                <div 
                    class="d-flex" v-for="(skill, index) in mentorSelected.skills" 
        ...
        <p class="subtitle white--text font-weight-light ml-4 mt-6 mb-0" v-if="mentorSelected">
            Más mentores
        </p>
        ...
        >
            <v-btn 
                ...
                width="100%" 
                height="65" 
                class="rounded-lg justify-end" 
                @click="goToChat(mentor)"
            >
                <div>
                    <span class="subtitle-1 white--text text-capitalize font-weight-light text-end pr-4">
                        {{ mentor.name }}
                    </span>
                    <p class="subtitle-2 white--text text-capitalize font-weight-light text-end pr-4 mb-0">
                        Mentor
                    </p>
                </div>
